...
public class BloodDonor {
	...
	public BloodDonor(@NotNull String bloodGroup, @NotNull String state, @NotNull String area, @NotNull int pinCode,
			@NotNull Long contactNo, User user) {
		super();
	...
	public String toString() {
		return "BloodDonor [id=" + id + ", bloodGroup=" + bloodGroup + ", state=" + state + ", area=" + area
				+ ", pinCode=" + pinCode + ", contactNo=" + contactNo + ", user=" + user + "]";
	}
