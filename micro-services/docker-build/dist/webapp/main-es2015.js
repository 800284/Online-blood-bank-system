...
let SignupSuccessComponent = class SignupSuccessComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let UserService = class UserService {
    ...
    addUser(user) {
        let url = src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].baseUrl + "/authentication-service/blood-bank/users";
...
let AddBloodRequirementComponent = class AddBloodRequirementComponent {
    constructor(formService, bloodService, router) {
...
AddBloodRequirementComponent.ctorParameters = () => [
...
let AvailabiltyComponent = class AvailabiltyComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let BloodAvailabilityComponent = class BloodAvailabilityComponent {
    constructor(authService, formService, bloodAvailabilityService) {
        this.authService = authService;
        this.formService = formService;
    ...
    search(form) {
        this.bloodAvailabilityService.getAllAvailableBloodGroups(form.value.bloodGroupDivision.bloodGroup, form.value.stateDivision.state, form.value.areaDivision.area).subscribe(response => {
...
BloodAvailabilityComponent.ctorParameters = () => [
...
let BloodDonationComponent = class BloodDonationComponent {
    constructor(formService, bloodAvailabilityService) {
        this.formService = formService;
        this.bloodAvailabilityService = bloodAvailabilityService;
...
BloodDonationComponent.ctorParameters = () => [
    { type: _form_service_service__WEBPACK_IMPORTED_MODULE_3__["FormServiceService"] },
    { type: _blood_service__WEBPACK_IMPORTED_MODULE_4__["BloodService"] }
];
...
let BloodRequestComponent = class BloodRequestComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let BloodRequirementAdditionSuccessComponent = class BloodRequirementAdditionSuccessComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let BloodService = class BloodService {
    constructor(httpClient, authService) {
        this.httpClient = httpClient;
        this.authService = authService;
    }
    addBloodRequirement(bloodRequirement) {
        let url = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + "/blood-service/blood-requirement/insert";
    ...
    viewAllRequirements() {
        let url = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + "/blood-service/blood-requirement/fetch";
        return this.httpClient.get(url);
    }
    getAllAvailableBloodGroups(bloodGroup, state, area) {
        let baseUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + '/blood-service/blood-bank/blood-availability';
        let httpOption = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'content-type': 'application/json',
    ...
    bookHospitalSlot(hospitalBookingrequest, username) {
        let baseUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + '/blood-service/blood-bank/donate/' + username;
        let httpOption = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'content-type': 'application/json',
                'Authorization': 'Bearer ' + this.authService.getToken()
    ...
    getAllDonorExperience() {
        let baseUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + '/blood-service/blood-bank/donor-experience';
        let httpOption = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'content-type': 'application/json'
            })
    ...
    postDonorExperience(userExperience) {
        let baseUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + '/blood-service/blood-bank/donor-experience';
        let httpOption = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'content-type': 'application/json',
    ...
    getFAQs() {
        let baseUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + '/blood-service/blood-bank/faq';
        let httpOption;
        if (this.authService.isLogin()) {
            httpOption = {
                headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
    ...
    postQuestion(username, faq) {
        let baseUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + '/blood-service/blood-bank/faq/' + username;
        let httpOption = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'content-type': 'application/json',
                'Authorization': 'Bearer ' + this.authService.getToken()
    ...
    answerQuestion(faq) {
        let baseUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + '/blood-service/blood-bank/faq/edit-question';
        let httpOption = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'content-type': 'application/json',
                'Authorization': 'Bearer ' + this.authService.getToken()
    ...
    getUsersQuestion(username) {
        let baseUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + '/blood-service/blood-bank/faq/get-question/' + username;
        let httpOption = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'content-type': 'application/json',
                'Authorization': 'Bearer ' + this.authService.getToken()
    ...
    getNotification(username) {
        let baseUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + '/blood-service/blood-bank/notification/' + username;
        let httpOption = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'content-type': 'application/json',
                'Authorization': 'Bearer ' + this.authService.getToken()
    ...
    removeNotifications(id) {
        let baseUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + '/blood-service/blood-bank/notification-history-id/' + id;
        let httpOption = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'content-type': 'application/json',
                'Authorization': 'Bearer ' + this.authService.getToken()
    ...
    updateNotification(username) {
        let baseUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + '/blood-service/blood-bank/update-notification/' + username;
        let httpOption = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'content-type': 'application/json',
                'Authorization': 'Bearer ' + this.authService.getToken()
    ...
    showAvailableUnits() {
        let baseUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + '/blood-service/blood-bank/blood-availability/fetch-blood-availability-admin/';
        let httpOption = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'content-type': 'application/json',
                'Authorization': 'Bearer ' + this.authService.getToken()
    ...
    postBloodNeededNotification(bloodGroup) {
        let baseUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + '/blood-service/blood-bank/blood-availability/insert-notification-specific-blood-group/' + bloodGroup;
        let httpOption = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'content-type': 'application/json',
                'Authorization': 'Bearer ' + this.authService.getToken()
    ...
    postBloodDonationNotification(userName) {
        let baseUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + '/blood-service/blood-bank/blood-donation-notification/' + userName;
        let httpOption = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'content-type': 'application/json',
                'Authorization': 'Bearer ' + this.authService.getToken()
...
let BookHospitalComponent = class BookHospitalComponent {
    constructor(formService, bloodService, authService) {
        this.formService = formService;
        this.bloodService = bloodService;
        this.authService = authService;
...
BookHospitalComponent.ctorParameters = () => [
    { type: _form_service_service__WEBPACK_IMPORTED_MODULE_3__["FormServiceService"] },
    { type: _blood_service__WEBPACK_IMPORTED_MODULE_4__["BloodService"] },
...
let FaqComponent = class FaqComponent {
    constructor(bloodService, authService) {
        this.bloodService = bloodService;
        this.authService = authService;
        //faqArray:string[];
        this.faqArray = [];
    ...
    ngOnInit() {
        ...
        this.bloodService.getFAQs().subscribe((response) => {
...
let FormServiceService = class FormServiceService {
    constructor() {
...
let HeaderComponent = class HeaderComponent {
    constructor(router, authService, bloodService) {
        this.router = router;
        this.authService = authService;
        this.bloodService = bloodService;
...
let HomePageComponent = class HomePageComponent {
    constructor(router, bloodService, authService) {
        this.router = router;
        this.bloodService = bloodService;
        this.authService = authService;
        this.notificationStatus = false;
    ...
    ngOnInit() {
        this.bloodService.viewAllRequirements().subscribe((response) => {
        ...
        if (this.authService.getLoggedinUser() != 'admin' && this.authService.getLoggedinUser() != null) {
            this.bloodService.getNotification(this.authService.getLoggedinUser()).subscribe((response) => {
                this.bloodNotifications = response;
                console.log(this.bloodNotifications);
...
let NotificationsComponent = class NotificationsComponent {
    constructor(bloodService, authService, route) {
        this.bloodService = bloodService;
        this.authService = authService;
        this.route = route;
...
let PostDonorExperienceComponent = class PostDonorExperienceComponent {
    constructor(authService, bloodService) {
        this.authService = authService;
        this.bloodService = bloodService;
...
PostDonorExperienceComponent.ctorParameters = () => [
    { type: _User_authentication_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"] },
...
let RouteToTipsComponent = class RouteToTipsComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ShowAvailableUnitsComponent = class ShowAvailableUnitsComponent {
    constructor(bloodService, authService) {
        this.bloodService = bloodService;
        this.authService = authService;
        this.notified = false;
...
ShowAvailableUnitsComponent.ctorParameters = () => [
    { type: _blood_service__WEBPACK_IMPORTED_MODULE_2__["BloodService"] },
    { type: _User_authentication_service__WEBPACK_IMPORTED_MODULE_3__["AuthenticationService"] }
];
...
let SignupComponent = class SignupComponent {
    constructor(userService, router, formService) {
...
let UserQuestionsComponent = class UserQuestionsComponent {
    constructor(bloodService, authService) {
        this.bloodService = bloodService;
        this.authService = authService;
    }
...
UserQuestionsComponent.ctorParameters = () => [
    { type: _blood_service__WEBPACK_IMPORTED_MODULE_2__["BloodService"] },
    { type: _User_authentication_service__WEBPACK_IMPORTED_MODULE_3__["AuthenticationService"] }
];
...
let ViewAllBloodRequirementsComponent = class ViewAllBloodRequirementsComponent {
    constructor(router, bloodService) {
        this.router = router;
        this.bloodService = bloodService;
        this.requirementIsThere = false;
    }
...
ViewAllBloodRequirementsComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _blood_service__WEBPACK_IMPORTED_MODULE_3__["BloodService"] }
];
...
let ViewAllDonorExperiencesComponent = class ViewAllDonorExperiencesComponent {
    constructor(bloodService) {
        this.bloodService = bloodService;
    }
    ngOnInit() {
...
ViewAllDonorExperiencesComponent.ctorParameters = () => [
    { type: _blood_service__WEBPACK_IMPORTED_MODULE_2__["BloodService"] }
];
